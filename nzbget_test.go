...
[
	...
	},
	{
		...
		"DataTime": 1589637733,
		"FirstDay": 17894,
		"TotalSizeLo": 2361608510,
		"TotalSizeHi": 3,
		"TotalSizeMB": 14540,
		"CustomSizeLo": 2361608510,
		"CustomSizeHi": 3,
		"CustomSizeMB": 14540,
		"CustomTime": 1546097163,
		"SecSlot": 13,
...
`)
	...
	if !reflect.DeepEqual(out[2], ServerVolume{
		ID:         1,
		TotalBytes: 15246510398, // 15246510398/1024/1024 == 14540 MB (TotalSizeMB)
	}) {
		t.Errorf("Unexpected ServerVolume[2]: %#v", out[2])
	}
}
